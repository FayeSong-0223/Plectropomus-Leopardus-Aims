...
say("never seen removes that overlap: for an unseen site the random intercept is")
say("unknown rather than estimated, so it is integrated out, and the question becomes")
say("whether the fixed effects alone predict a new site's counts any better with")
say("management in the model than without it.")
say("")
